          ...
          <Box>
            <Grid container spacing={4}>
              ...
              <div>
                {" "}
                <p>
                  At AltDeck, accessible at Altdeck.io, one of our main priorities is the privacy of our
                  visitors. This Privacy Policy document contains types of information that is collected
                  and recorded by AltDeck and how we use it. If you have additional questions or require
                  more information about our Privacy Policy, do not hesitate to contact us through email
                  at contact@altdeck.io contact@altdeck.io This privacy policy applies only to our online
                  activities and is valid for visitors to our website with regards to the information that
                  they shared and/or collect in AltDeck. This policy is not applicable to any information
                ...
                <p>
                  ...
                  <ul>
                    ...
                    <li>
                      For creators on collections & launchpad, we publicly display given information about
                      the team on the creator’s collection or and launchpad page
                    </li>
                ...
                <h2>Log Files</h2>
                <p>
                  AltDeck follows a standard procedure of using log files. These files log visitors when
                ...
                <p>
                  Like any other website, AltDeck uses ‘cookies'. These cookies are used to store information
                ...
                <p>
                  ...
                  cookies, to serve ads to our site visitors based upon their visit to www.AltDeck.com and
                  ...
                  URL – https://policies.google.com/technologies/ads. Some of advertisers on our site
                  may use cookies and web beacons. Our advertising partners are listed below. Each of
